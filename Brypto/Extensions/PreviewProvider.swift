...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$12.51B", percentageChange: 25.34)
    let stat2 = StatisticModel(title: "Total Volume", value: "1.23T")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "50.40k", percentageChange: -12.91)
    
    let category = MarketCategoryDataModel(id: "ethereum-ecosystem", name: "Ethereum Ecosystem", marketCap: 480199895102.1914, marketCapChange24h: 1.8192687244610233, content: "Smart contract platforms are usually blockchains that host smart contracts or decentralized applications. Users can interact with different smart contracts on these platforms to perform various actions such as lending and borrowing funds, staking their assets or minting NFTs.\r\n\r\nSmart contracts are programs that are stored on the blockchain and are automatically executed when certain conditions are met. To interact with these smart contracts, transaction fees may need to be paid and the amount and asset required will vary based on the platform’s architecture. Usually, the smart contract platform’s native token is used to pay for transaction fees. Some popular examples of smart contract platforms include Ethereum, Solana and Polygon.", top3Coins: [
        "https://assets.coingecko.com/coins/images/279/small/ethereum.png?1595348880",
        "https://assets.coingecko.com/coins/images/325/small/Tether-logo.png?1598003707",
        "https://assets.coingecko.com/coins/images/6319/small/USD_Coin_icon.png?1547042389"
      ], volume24h: 77985354084.34267)
    ...
    let coin = CoinModel(
        ...
        currentHoldings: 1.5, isBookmarked: false)
}
